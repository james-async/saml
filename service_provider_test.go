...
func (test *ServiceProviderTest) TestCanProduceMetadata(c *C) {
	s := ServiceProvider{
		...
		LogoutResponseURL: mustParseURL("https://example.com/saml2/logoutResponse"),
...
func (test *ServiceProviderTest) TestCanProduceRedirectRequest_ForLogoutRequest(c *C) {
	...
	c.Assert(string(decodedRequest), Equals,
		"<samlp:LogoutRequest xmlns:saml=\"urn:oasis:names:tc:SAML:2.0:assertion\" xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" ID=\"id-00020406080a0c0e10121416181a1c1e20222426\" Version=\"2.0\" IssueInstant=\"2015-12-01T01:31:21.123Z\" Destination=\"https://the_location_url/logout\"><saml:Issuer Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:entity\">https://15661444.ngrok.io/saml2/metadata</saml:Issuer><saml:NameID SPNameQualifier=\"https://15661444.ngrok.io/saml2/metadata\" Format=\"urn:oasis:names:tc:SAML:2.0:nameid-format:transient\">whoever</saml:NameID><ds:Signature xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\"><ds:SignedInfo><ds:CanonicalizationMethod Algorithm=\"http://www.w3.org/2006/12/xml-c14n11\"/><ds:SignatureMethod Algorithm=\"http://www.w3.org/2001/04/xmldsig-more#rsa-sha256\"/><ds:Reference URI=\"#id-00020406080a0c0e10121416181a1c1e20222426\"><ds:Transforms><ds:Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/><ds:Transform Algorithm=\"http://www.w3.org/2006/12/xml-c14n11\"/></ds:Transforms><ds:DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"/><ds:DigestValue>B1cN6vtWmyrwSqmrKentdDFFN20Eur6j1NQxHjkcjY4=</ds:DigestValue></ds:Reference></ds:SignedInfo><ds:SignatureValue>XVgvGRwlH/xJWsllCLcZJ0iQ9IVBrgmI24KQI/nz6H41Ne861/uwydigR9p9niuMOJoBj49ID36ptM/QT1ZU17ojHSlOjcBCRQxu2hCqBZ4nupujN0qnMmblaU+UUuHvX7M3Icezf+TTxV8/zvDJsLudZ16+SZ/tlCsEHm+PuRo=</ds:SignatureValue><ds:KeyInfo><ds:X509Data><ds:X509Certificate></ds:X509Certificate></ds:X509Data></ds:KeyInfo></ds:Signature></samlp:LogoutRequest>")
}
